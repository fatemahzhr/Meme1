...
//  MemeMe_version2.0
//
//  Created by Fatimah Abdulraheem on 8/12/2018.
//  Project Name: MemeMe 2.0
//  Project Discription: this project will make the user able to select an image from the album or Camera then edit it by writing a top and bottom text then share it at the end. In Meme 2.0 the user can view the memes as table and collection views
//
...
class ViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        //*****************************************
        //Fill data with Collection View Images:
        //self.fillDemoDataInfo()
    ...
    func save(_memedImage: UIImage){
        let meme = MStruct(memedImage: generateMemedImage(), originalImage: imagePickerView.image!, topText: topText.text!, bottomText: bottomText.text!)
